    ...
    @if(isset($SV))
      ...
      <div class="row">
        <div class="x_panel">
          ...
          <div class="x_content">
            <!-- Form information -->
            <form method="POST" action="{{route('admin_poststudentupdate')}}" enctype="multipart/form-data">
              {{csrf_field()}}
                ...
                <div class="col-lg-10 col-md-8 col-xs-12">
                  <div class="row">
                    ...
                    <div class="row">
                      ...
                      <div class="form-group col-xs-12 col-sm-12 col-md-6 col-lg-6 col-xl-6{{ $errors->has('ngaysinh') ? ' has-error' : '' }}">
                        <label for="ngaysinh">Ngày sinh</label>
                        <input type="date" name="ngaysinh" class="form-control" value="{{old('ngaysinh', $SV->ngaysinh, date('d/m/Y'))}}" placeholder="Ngày sinh" width="100%">

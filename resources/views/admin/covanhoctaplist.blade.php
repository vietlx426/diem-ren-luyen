    ...
    <div class="x_panel">
      <div class="x_title">
        ...
        <div class="pull-right">
          <a href=" {{route('admin_covanhoctap_create')}} " class="btn btn-primary"><strong><i class="fa fa-plus"></i> THÊM </strong></a>
        </div>
                ...
                @foreach($dsCoVanHocTap as $coVanHocTap)
                    <tr>
                        ...
                        <td class="text-center">
                          <a href="{{route('admin_covanhoctap_edit', ['id'=>$coVanHocTap->id])}}" class="btn btn-warning"  title="Sửa cố vấn học tập"><i class="fa fa-edit"></i></a>
                          <a href="{{route('admin_covanhoctap_destroy', ['id'=>$coVanHocTap->id])}}" class="btn btn-danger"  title="Xóa cố vấn học tập"><i class="fa fa-remove"></i></a>
                        </td>
                    </tr>
                @endforeach
              @endif

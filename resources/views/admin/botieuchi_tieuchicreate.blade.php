...
@section('content')
    <div class="row">
        <div class="x_panel">
            ...
            <div class="x_content">
                <form action="{{route('admin_botieuchi_tieuchi_store')}}" method="POST" class="form-horizontal form-label-left" enctype="multipart/form-data">
                    {{csrf_field()}}
                    ...
                    <div class="row">
                        @if(isset($tieuChiCha) && $tieuChiCha)
                            <input type="text" name="idtieuchicha" class="hidden" hidden="true" value="{{$tieuChiCha->id}}">
                            <div class="col-xs-12 col-sm-12 col-md-10 col-lg-10 col-xl-10 {{$errors->has('tieuchicha') ? ' has-error' : ''}}">
                                <div class="form-group">
                                    <label class="control-label col-md-3 col-sm-3 col-xs-12" for="tieuchicha">Tiêu chí cha<span class="required"></span></label>
                                    <div class="col-md-9 col-sm-9 col-xs-12">
                                        <input type="text" class="inpmuc form-control" readonly="true" value="{{$tieuChiCha->chimuctieuchi}} {{$tieuChiCha->tentieuchi}}">
                                        <span class="help-block">
                                            <strong id="help-error-minhchung">{{ $errors->first('tieuchicha') }}</strong>
                                        </span>
                                    </div>
                                </div>
                            </div>
                        ...
                        <div class="col-xs-12 col-sm-12 col-md-10 col-lg-10 col-xl-10 {{$errors->has('chimuc') ? ' has-error' : ''}}">
                            <div class="form-group">
                                ...
                                <div class="col-md-9 col-sm-9 col-xs-12">
                                    <input type="text" name="chimuc" id="chimuc" class="form-control" value="{{old('chimuc')}}" placeholder="Chỉ mục">
                                    <span class="help-block">
                        ...
                        <div class="col-xs-12 col-sm-12 col-md-10 col-lg-10 col-xl-10 {{$errors->has('noidungtieuchi') ? ' has-error' : ''}}">
                            <div class="form-group">
                                ...
                                <div class="col-md-9 col-sm-9 col-xs-12">
                                    <textarea id="txttentieuchi" name="noidungtieuchi" class="txttentieuchi form-control">{{old('noidungtieuchi')}}</textarea>
                                    <span class="help-block">
                        ...
                        <div class="col-xs-12 col-sm-12 col-md-10 col-lg-10 col-xl-10 {{$errors->has('noidungtieuchitomtat') ? ' has-error' : ''}}">
                            <div class="form-group">
                                ...
                                <div class="col-md-9 col-sm-9 col-xs-12">
                                    <textarea id="txttentieuchi" name="noidungtieuchitomtat" class="txttentieuchi form-control">{{old('noidungtieuchitomtat')}}</textarea>
                                    <span class="help-block">
                                ...
                                <div class="col-md-9 col-sm-9 col-xs-12">
                                    @if(isset($dsLoaiDiem))
                                        @foreach($dsLoaiDiem as $loaiDiem)
                                            <input type="radio" class="LoaiDiem flat" id="inploaidiem{{$loaiDiem->id}}" name="loaidiem" value="{{$loaiDiem->id}}" {{$loaiDiem->id==old('loaidiem')?'checked="true"':''}}>
                        ...
                        <div class="col-xs-12 col-sm-12 col-md-10 col-lg-10 col-xl-10 {{$errors->has('diemtoida') ? ' has-error' : ''}}">
                            <div class="form-group">
                                ...
                                <div class="col-md-9 col-sm-9 col-xs-12">
                                    <input type="number" name="diemtoida" min="0" max="100" class="inpdiemtoida form-control" value="{{old('diemtoida')}}">
                                    <span class="help-block">
                        ...
                        <div class="col-xs-12 col-sm-12 col-md-10 col-lg-10 col-xl-10 {{$errors->has('diemmacdinh') ? ' has-error' : ''}}">
                            <div class="form-group">
                                ...
                                <div class="col-md-9 col-sm-9 col-xs-12">
                                    <input type="number" name="diemmacdinh" min="0" max="100" class="inpdiemmacdinh form-control" value="{{old('diemmacdinh', 0)}}">
                                    <span class="help-block">
                                    ...
                                    @if(isset($dsModule))
                                        <select class="form-control" name="module" title="Chọn module để tính điểm, nếu không sẽ lấy điểm trực tiếp từ file import (minh chứng)">
                                            ...
                                            @foreach($dsModule as $module)
                                                    <option value="{{$module->id}}" {{$module->id==old('module')?'selected="true"':''}}>{{$module->modulename}}</option>
                                ...
                                <div class="col-md-9 col-sm-9 col-xs-12">
                                    @if(isset($dsTrangThai))
                                        @foreach($dsTrangThai as $trangThai)
                                            <input type="radio" class="TrangThai flat" id="inptrangthai{{$trangThai->id}}" name="trangthai" value="{{$trangThai->id}}" {{$trangThai->id==old('trangthai')?'checked="true"':''}}>

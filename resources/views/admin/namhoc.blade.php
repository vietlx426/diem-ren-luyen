                                ...
                                @foreach($DanhSach_NamHoc as $NamHoc)
                                    <tr>
                                        ...
                                        <td class="text-center">
                                            <button type="button" class="btn btn-warning" data-toggle="modal" data-target="#CapNhatNamHocModal" title="Sửa" onclick="CapNhatNamHoc('{{$NamHoc->id}}', '{{$NamHoc->manamhoc}}','{{$NamHoc->tennamhoc}}')">
                                                <i class="fa fa-pencil-square-o"></i>
                                            </button>
                                            <button type="button" class="btn btn-danger remove_namhoc" href="{{route('namhoc_destroy',['id'=>$NamHoc->id])}}" Ten="{{$NamHoc->tennamhoc}}" title="Xóa"><i class="fa fa-trash"></i>
                                            </button>
                                        </td>
                                    </tr>
                                @endforeach

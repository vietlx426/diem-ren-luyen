...
@section('content')
  <div class="row">
    <div class="x_panel">
      ...
      <div class="x_content">
        <form action="{{route('admin_botieuchi_store')}}" method="POST" class="form-horizontal form-label-left" enctype="multipart/form-data">
            {{csrf_field()}}
            ...
            <div class="row">
                <div class="col-xs-12 col-sm-12 col-md-10 col-lg-10 col-xl-10 {{$errors->has('tenbotieuchi') ? ' has-error' : ''}}">
                    <div class="form-group">
                        ...
                        <div class="col-md-9 col-sm-9 col-xs-12">
                            <input type="text" name="tenbotieuchi" id="tenbotieuchi" class="form-control" value="{{old('tenbotieuchi')}}" placeholder="Bộ tiêu chí">
                ...
                <div class="col-xs-12 col-sm-12 col-md-10 col-lg-10 col-xl-10 {{$errors->has('motabotieuchi') ? ' has-error' : ''}}">
                    <div class="form-group">
                        ...
                        <div class="col-md-9 col-sm-9 col-xs-12">
                            <textarea name="motabotieuchi" id="motabotieuchi"  rows="5" class="form-control" placeholder="Mô tả/Ghi chú">{{old('motabotieuchi')}}</textarea>
                            <span class="help-block">

    ...
    <div class="x_panel">
      ...
      <div class="x_content">
        <div class="row">
          ...
          <form action="{{route('admin_hoatdongsukien_update')}}" method="POST" class="form-horizontal form-label-left">
            {{csrf_field()}}
            <input type="text" name="idhoatdongsukien" value="{{$hoatdongsukien->id}}" class="hidden" hidden="true">

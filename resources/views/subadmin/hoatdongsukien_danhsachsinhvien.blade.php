...
@section('content')
  <div class="row">
    <div class="x_panel">
      <div class="x_title">
        <h2><a href="{{route('hoatdongsukien')}}" class="btn btn-success" title="Quay về danh sách hoạt động - sự kiện"> <i class="fa fa-undo"></i> </a> DANH SÁCH SINH VIÊN THAM GIA HOẠT ĐỘNG - SỰ KIỆN <small>ACTIVITIES - EVENTS LIST</small></h2>
      ...
      <div class="x_content">
        ...
        @if(isset($DS_DKHoatDongSuKien))
            @if(count($DS_DKHoatDongSuKien)>0)
                <?php $STT = '0' ?>

                ...
                <tbody>
                    @foreach($DS_HoatDongSuKien as $HDSK)
                        <tr>
                            ...
                            <td>{{$HDSK->diadiem}}</td>
                            <td>
                              <a href="{{route('subadmin_hoatdongsukien_danhsachsinhvien', ['idhoatdongsukien'=>$HDSK->id])}}" class="btn btn-info" title="Danh sách tham dự"> <i class="fa fa-info-circle"></i> </a>
                            </td>
                        </tr>
                    @endforeach
                </tbody>

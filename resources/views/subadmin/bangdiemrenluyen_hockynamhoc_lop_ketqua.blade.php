                ...
                @if(isset($dsSinhVien_Diem_XepLoai) && count($dsSinhVien_Diem_XepLoai) > 0)
                    ...
                    <div class="row">
                        <div class="text-center">
                            <a href="{{route('subadmin_bangdiemdiemrenluyen_hockynamhoc_lop_export', ['idhockynamhoc'=>(isset($hocKyNamHoc)? $hocKyNamHoc->id : ''), 'idlop'=>(isset($lop)?$lop->id:'')])}}" class="btn btn-success btn_export_bangdiem_bcs btn-download">

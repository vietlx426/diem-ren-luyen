                                ...
                                <tr>
                                    ...
                                    @else
                                        ...
                                        @if($tieuChi->module_id == 2)
                                            <td class="text-center-middle"><a target="_blank" href="{{route('sinhvien_tieuchi_minhchung_module', ['idhockynamhoc'=>$idHocKy, 'idtieuchi'=>$tieuChi->id, 'idmodule'=>$tieuChi->module_id])}}" class="btn btn-primary" title="Xem minh chứng"><i class="fa fa-eye"></i> </a></td>
                                        @else
                                            <td class="text-center-middle"><a target="_blank" href="{{route('sinhvien_tieuchi_minhchung', ['idhockynamhoc'=>$idHocKy, 'idtieuchi'=>$tieuChi->id])}}" class="btn btn-primary" title="Xem minh chứng"><i class="fa fa-eye"></i> </a></td>
                                        @endif
                                    @endif
                                </tr>
                                {{App\Http\Controllers\TieuChiController::SinhVien_TieuChiCon_MinhChung($tieuChi->id, $boTieuChi, $idHocKy)}}
                            @endforeach
                        </tbody>
                        <tfoot>
                            <tr>

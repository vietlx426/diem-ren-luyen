                                ...
                                <tr>
                                    ...
                                    <th class="text-center-middle">
                                        @if($tieuChiMinhChung->fileupload)
                                            <a href="{{route('sinhvien_tieuchi_minhchung_downloadfileimport', ['idtieuchiminhchung'=>$tieuChiMinhChung->id])}}" class="btn btn-success"><i class="fa fa-download"></i></a>
                                        @endif
                                    </th>
                                    <!-- <th class="text-center-middle">
                                        @if($tieuChiMinhChung->filescan)
                                            <a href="{{route('sinhvien_tieuchi_minhchung_downloadfileminhchung', ['idtieuchiminhchung'=>$tieuChiMinhChung->id])}}" class="btn btn-primary"><i class="fa fa-download"></i></a>
                                        @endif
                                    </th> -->
                                </tr>
                            @endforeach

<!-- left menu   -->
    ...
    <div id="sidebar-menu" class="main_menu_side hidden-print main_menu">
        ...
        <ul class="nav side-menu">
            <li><a href="{{route('covanhoctap')}}"><i class="fa fa-desktop"></i>DASHBOARD</a></li>
            <li> <a href="{{route('covanhoctap_bangdiemrenluyen')}}"><i class="fa fa-list-alt"></i>KẾT QUẢ ĐRL</a> </li>

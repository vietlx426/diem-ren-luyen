...
@section('content')
    <div class="row">
        <div class="x_panel">
            <div class="x_title">
                <h2> <i class="fa fa-edit"></i> BẢNG ĐIỂM RÈN LUYỆN <small>{{isset($hocKyNamHoc)?$hocKyNamHoc->tenhockynamhoc:''}}</small></h2>
                ...
                @if(isset($dsSinhVien_Diem_XepLoai) && count($dsSinhVien_Diem_XepLoai) > 0)
                    ...
                    <div class="row">
                        <div class="text-center">
                            <a href="{{route('covanhoctap_bangdiemdiemrenluyen_hockynamhoc_export', ['idhockynamhoc'=>(isset($idHocKyNamHoc)? $idHocKyNamHoc : ''), 'idlop'=>(isset($idLop)?$idLop:'')])}}" class="btn btn-success btn_export_bangdiem_bcs btn-download">

...
@section('content')
  @if(isset($hoatDongSuKien))
    <div class="row">
      <div class="x_panel">
        <div class="x_title">
          <h2> <a href="{{route('giaovukhoa_hoatdongsukien')}}" class="btn btn-success" title="Quay về danh sách hoạt động - sự kiện"> <i class="fa fa-undo"></i> </a> THÔNG TIN HOẠT ĐỘNG - SỰ KIÊN</h2>

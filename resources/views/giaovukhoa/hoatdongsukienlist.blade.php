                        ...
                        @foreach($dsHoatDongSuKienHienHanh as $HDSK)
                          <tr>
                              ...
                              <td class="text-center">
                                <a href="{{route('giaovukhoa_hoatdongsukien_show', ['id'=>$HDSK->id])}}" class="btn btn-info a-wating" title="Xem thông tin chi tiết"> <i class="fa fa-info-circle"></i> </a>
                              </td>
                          </tr>
                      @endforeach
                    </tbody>

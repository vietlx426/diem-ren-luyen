            ...
            <li>
              ...
              <ul class="menu">
                ...
                <li>
                  <a href="#">
                    <div class="pull-left">
                      <img src="{{URL::asset('dashboard/dist/img/user3-128x128.jpg')}}" class="img-circle" alt="User Image">
                    </div>
                    <h4>
                ...
                <li>
                  <a href="#">
                    <div class="pull-left">
                      <img src="{{URL::asset('dashboard/dist/img/user4-128x128.jpg')}}" class="img-circle" alt="User Image">
                    </div>
                    <h4>
                      Developers
        ...
        @if (Route::has('login'))
          @auth
            <li class="dropdown user user-menu">
              <a href="#" class="dropdown-toggle" data-toggle="dropdown">
                <img src="{{URL::asset('dashboard/dist/img/user2-160x160.jpg')}}" class="user-image" alt="User Image">

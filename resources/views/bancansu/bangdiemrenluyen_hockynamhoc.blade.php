                ...
                @if(isset($dsSinhVien_Diem_XepLoai) && count($dsSinhVien_Diem_XepLoai) > 0)
                    ...
                    <div class="row">
                        <div class="text-center">
                            <a href="{{route('bancansu_bangdiemdiemrenluyen_hockynamhoc_export', ['idhockynamhoc'=>(isset($idHocKyNamHoc)? $idHocKyNamHoc : ''), 'idlop'=>(isset($idLop)?$idLop:'')])}}" class="btn btn-success btn_export_bangdiem_bcs btn-download">

      ...
      <div class="x_content">
        ...
        <div class="row text-center">
          <div class="col-xs-12 col sm-12 col-md-4 col-lg-4 col-xl-4 col-md-offset-4 col-lg-offset-4 col-xl-offset-4 form-group">
            <label for="inpmssv">MÃ SỐ SINH VIÊN</label>
            <input type="text" id="inpmssv" name="mssv" class="form-control" autofocus placeholder="MSSV">
          </div>
        </div>

        <div class="row text-center">
          <button class="btn btn-primary truongdonvi_student_filter">
...
@section('javascript')
    ...
    <script type="text/javascript">
      ...
      var urlRoute_truongdonvi_sinhvien_show = "{{route('truongdonvi_sinhvien_show')}}";
    </script>
@endsection
...
@section('content')
    <div class="text-center">
        ...
        <h4> {{isset($boTieuChi)?$boTieuChi->tenbotieuchi:''}} </h4>
    </div>
    <div class="row">
        <div class="x_panel">
            <div class="x_content">
                    ...
                    <table class="table table-striped">
                        <thead>
                            <tr>
                                ...
                                <th width="75%">Tên (mô tả minh chứng)</th>
                                ...
                                <tr>
                                    ...
                                    <th class="text-center-middle">
                                        @if($tieuChiMinhChung->fileupload)
                                            <a href="{{route('truongdonvi_tieuchi_minhchung_downloadfileimport', ['idtieuchiminhchung'=>$tieuChiMinhChung->id])}}" class="btn btn-success"><i class="fa fa-download"></i></a>
                                        @endif
                                    </th>
                                    <th class="text-center-middle">
                                        @if($tieuChiMinhChung->filescan)
                                            <a href="{{route('truongdonvi_tieuchi_minhchung_downloadfileminhchung', ['idtieuchiminhchung'=>$tieuChiMinhChung->id])}}" class="btn btn-primary"><i class="fa fa-download"></i></a>
                                        @endif
                                    </th>
                                </tr>
                            @endforeach

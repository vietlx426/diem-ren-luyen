            ...
            $.each(result.Data, function (index, value) {
                ...
                if(isEmpty(value['sinhvien_id']))
                {
                    tr += '<td class="text-center-middle">' +
                                '<a target="_blank" href="' + urlroute_adminstudentprofilepic + '/' + value['id'] + '" class="btn btn-danger" title="Chưa khai lý lịch. Click vào để cập nhật hình">' +
                ...
                {
                    tr += '<td class="text-center-middle">' +
                                '<a target="_blank" href="' + urlroute_adminstudentprofilepic + '/' + value['id'] + '" class="btn btn-success" title="Đã khai lý lịch. Click vào để cập nhật hình">' +
                                    '<i class="fa fa-info-circle"></i>' +
                                '</a>' +
                            '</td>';
                }

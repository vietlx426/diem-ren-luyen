...
function SearchStudent() {
    ...
    else
    {
        ...
        var url_full = $('.search_student_id').attr('url') + '/' + $('#mssv').val().trim() + '/' + $('#type').val();
            ...
            $.each(result.Data, function (index, value) {
                ...
                // {
                    tr += '<td class="text-center-middle">' +
                                '<a target="_blank" href="' + $('#div_url_studentprofile').val() + '/' + value['id'] + '" class="btn btn-warning" title="Click vào để cập nhật thông tin">' +
